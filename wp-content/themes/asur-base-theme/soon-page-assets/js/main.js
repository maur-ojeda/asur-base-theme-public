...
if ( $("body.mrs-body-slider").is_exist() ) {
  $("body.mrs-body-slider").vegas({
      ...
      slides: [
          { src: "http://gsdc.cl/wp-content/uploads/2025/06/04.png" },
          { src: "http://gsdc.cl/wp-content/uploads/2025/06/03.png" },
          { src: "http://gsdc.cl/wp-content/uploads/2025/06/02.png" },
          { src: "http://gsdc.cl/wp-content/uploads/2025/06/01.png" },
          
         
      ],
      overlay: 'http://gsdc.cl/wp-content/uploads/2025/06/pattern.png'
  });
}
